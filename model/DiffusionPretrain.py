...
class Diff_Point_MAE(nn.Module):
    def __init__(self, config):
        ...
        self.diffusion_output_size = config.diffusion_output_size
        self.num_channel = 3
        self.drop_path_rate = config.drop_path_rate
        self.mask_token = nn.Conv1d((self.num_channel * self.diffusion_output_size) // self.num_group, self.trans_dim, 1)
